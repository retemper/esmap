...
export default defineConfig(({ command }) => ({
  root: __dirname,
  cacheDir: resolve(__dirname, '../../node_modules/.vite/deps-notifications'),
  ...
  build: {
    ...
    outDir: resolve(__dirname, '../../dist/apps/notifications'),
    emptyOutDir: true,
    rollupOptions: {
  ...
  plugins: [
    ...
    esmapCssScope({ appName: '@enterprise/notifications' }),
  ],
}));
